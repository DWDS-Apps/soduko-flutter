          ...
          return ListView(
            ...
            children: [
              Row(children: [
                ...
                Expanded(
                    child: _StatCard(
                        ...
                        label: 'Win %',
                        value: '${s.winPercentage.toStringAsFixed(0)}%',
                        color: Colors.purple)),
              ]),
              ...
              ...Difficulty.values.map((d) => _DifficultyStatsRow(
                  difficulty: d,
                  bestTime: s.getBestTime(d),
                  gamesCount: s.getGamesForDifficulty(d))),
              const SizedBox(height: 24),
              Container(
                padding: const EdgeInsets.all(16),
                ...
                child: Row(children: [
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Text(_formatTime(s.averageTime.toInt()),
                            style: const TextStyle(
                                fontSize: 22, fontWeight: FontWeight.bold)),
                      ]),
                  const Spacer(),
                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    const Text('Total Hints',
                        style: TextStyle(fontSize: 13, color: Colors.grey)),
                    Text('${s.totalHintsUsed}',
                        style: const TextStyle(
                            fontSize: 22, fontWeight: FontWeight.bold)),
                  ]),
                ]),
